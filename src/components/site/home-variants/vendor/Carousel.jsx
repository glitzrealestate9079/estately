...
const DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    id: 4,
    icon: <LayoutGrid className="h-[16px] w-[16px] text-white" />
  },
  {
    title: 'Common UI',
...
export default function Carousel({
  ...
  const [resetKey, setResetKey] = useState(`${items.length}-${loop}-${trackItemOffset}`);
  ...
  const nextResetKey = `${items.length}-${loop}-${trackItemOffset}`;
