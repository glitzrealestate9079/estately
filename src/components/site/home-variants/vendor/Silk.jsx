...
const Silk = ({ speed = 5, scale = 1, color = '#7B7481', noiseIntensity = 1.5, rotation = 0, lightMode = false }) => {
  ...
  useEffect(() => {
    // Uniform objects are handed to Three.js's imperative render loop, not
    // read by React itself — mutating their .value in place (rather than
    // replacing the object) is the standard react-three-fiber pattern for
    // updating shader uniforms without re-triggering the memo.
