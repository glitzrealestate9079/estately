...
// Converted from TSX to plain JSX for this project (types stripped, behavior unchanged).
...
export default function InteractiveListPreview({
  ...
  const animateImageOut = (index) => {
    ...
    gsap.to(imageElement, {
      ...(reduceMotion ? { opacity: 0 } : { clipPath: IMAGE_HIDDEN_CLIP_PATH, opacity: 0 }),
            ...
            <table className="relative z-30 w-full table-fixed border-collapse">
              ...
              <tbody>
                {items.map((item, index) => (
                  ...
                  >
                    <td className="whitespace-nowrap px-6 py-3 text-xs uppercase tracking-widest">{item.client}</td>
                    <td className="whitespace-nowrap px-6 py-3 text-xs uppercase tracking-widest">{item.platform}</td>
                    <td className="whitespace-nowrap px-6 py-3 text-center text-xs uppercase tracking-widest"> </td>
                    <td className="whitespace-nowrap px-6 py-3 text-xs uppercase tracking-widest">{item.services}</td>
                  </tr>
                ))}
