...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="animate-fade-in text-center">
        ...
        <Button className="mt-6 w-full" onClick={() => router.push("/reset-password")}>
  ...
  return (
    <div className="animate-fade-in">
      <Link href="/login" className="mb-6 flex items-center gap-1.5 text-sm font-medium text-foreground-muted hover:text-foreground">
