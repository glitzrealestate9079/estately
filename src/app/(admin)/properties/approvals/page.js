...
export default function PropertyApprovalsPage() {
  ...
  function confirmReject() {
    ...
    toast.warning(`${rejectTarget.title} rejected`, {
    ...
    <div className="space-y-6">
      ...
      <Modal open={!!rejectTarget} onOpenChange={(open) => !open && setRejectTarget(null)}>
        <ModalContent size="sm">
          <ModalHeader>
            <ModalTitle>Reject property</ModalTitle>
            <ModalDescription>Let {rejectTarget?.owner.name ?? "the owner"} know why this listing was rejected.</ModalDescription>
          </ModalHeader>
          <ModalBody>
