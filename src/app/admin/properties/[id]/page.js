          ...
          <Card>
            <div className="grid grid-cols-2 gap-1 p-1 sm:grid-cols-4">
              {property.images.map((src, i) => (
                <div key={`${property.id}-image-${i}`} className={i === 0 ? "relative col-span-2 row-span-2 aspect-square overflow-hidden rounded-lg sm:aspect-auto" : "relative aspect-square overflow-hidden rounded-lg"}>
